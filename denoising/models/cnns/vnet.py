...
class VNet(tf.keras.Model):
    ...
    Adds capability for different regularizers (TNRD, DnCNN, and TDV) and scaling weights"""
...
class VNetModel(DenoisingModel):
    ...
    def _add_keys_to_config(self):
        """
        Keys added to config if self.add_keys is True, gives example of config for small TNRD denoising model
        """
    ...
    def _train_layer_wise(self):
        ...
        adds four stages to model. Stops training once the model has been trained with S stages."""
